                ...
                <el-col :span="23">
                    <el-col :span="24">
                        <el-form
                            ...
                            <!--这是到期时间-->
                            <el-form-item
                                    v-if="searchData.selected.timer">
                                <el-select
                                        v-model="searchDate.select_timer"
                                        placeholder="到期时间"
                                        style="margin-top: 1px;"
                                        size="small"
                                        clearable
                                        @visible-change="visChange1"
                                        @change="selectTimerChange"
                                        class="smSreen">
                                    <el-option
                            ...
                            <!--状态选择-->
                            <el-form-item
                                    v-if="searchData.selected.state">
                                <el-select
                                        v-model="stateSelect"
                                        :placeholder="searchData.props.holder"
                                        style="margin-top: 1px;"
                                        size="small"
                                        @change="statesChange"
                                        clearable
                                        class="smSreen">
                                    <el-option
                                            v-for="item in searchData.typeDatas"
                                            :key="item.value"
                                            :label="item.name"
                                            :value="item.value">
                                    </el-option>
                            ...
                            <!--这是搜索框-->
                            <el-form-item
                                    v-if="searchData.selected.search_input">
                                <el-input
                                        size="small"
                                        :placeholder="searchData.props.holder"
                                        clearable
                                        v-model="searchDate.search_input"></el-input>
                            </el-form-item>
                            <!--这是选择订单状态-->
                            <el-form-item
                            ...
                            <!--账号创建部分-->
                            <el-form-item v-if="searchData.selected.creatAccount">
                                <el-button
                                        type="primary"
                                        size="small"
                                        @click="eventClick('creatAccount')"
                                        >创建账号</el-button>
                            </el-form-item>
                            <!--任务管理 上传结果-->
                            <el-form-item v-if="searchData.selected.taskUpdata">
                                <el-button
                                        type="primary"
                                        size="small"
                                        @click="eventClick('updataTask')"
                                        >上传结果</el-button>
                            </el-form-item>
                        </el-form>
                    </el-col>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            //选择框 选择
            selectTimerChange(data){
                this.$emit('timerChange',data);
            },
            ...
            * */
            ...
            eventClick(type){
                switch (type){
                    ...
                    //订单状态
                    case 'updataTask':
                        this.$emit('updataTask');
                        return;
                    case 'creatAccount':
                        this.$emit('creatAccount');
                        return;
                    default:
                        return
                }
