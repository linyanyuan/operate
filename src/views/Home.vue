                    ...
                    <el-col :span="8" class="userinfo">
                        ...
                        <el-dropdown trigger="hover" @command="handleCommand">
                         <span class="el-dropdown-link userinfo-inner">
                            ...
                            <el-dropdown-menu slot="dropdown">
                                <el-dropdown-item command="default">默认灰</el-dropdown-item>
                                <el-dropdown-item command="blue">天空蓝</el-dropdown-item>
                                <el-dropdown-item command="green">典雅绿</el-dropdown-item>
                                <el-dropdown-item command="blackberry">经典蓝</el-dropdown-item>
                            </el-dropdown-menu>
                        </el-dropdown>
                    </el-col>
                </div>
            ...
            <el-col :span="24" class="main">
                ...
                <el-scrollbar style="height: 100%">
                    <el-menu
                            ...
                            router
                            :collapse="isCollapse">
                        <el-menu-item v-for="val in menuDatas" :index="val.path" :key="val.sort">
                            <i :class="val.icon"></i>
                            <span slot="title" v-text="val.title"></span>
                        </el-menu-item>
                       <!-- <el-menu-item index="/home/index">
                            <i class="fa fa-home fa-lg"></i>
                            <span slot="title">首页</span>
                        </el-menu-item>
                        <el-menu-item index="/home/EnterpriseIndex">
                            <i class="fa fa-building"></i>
                            <span slot="title">企业管理</span>
                        </el-menu-item>
                        <el-menu-item index="/home/contractIndex">
                        ...
                        <el-menu-item index="/home/invoiceIndex/invoice_apply">
                            <i class="fa fa-list-ul"></i>
                            <span slot="title">申请开票</span>
                        </el-menu-item>-->
                    </el-menu>
                </el-scrollbar>
...
<script>
    ...
    export default {
        ...
        computed:{
            //映射State
            ...mapState({
                actives: state => state.active,//active激活
                menuData:state => state.menuData,//权限生成后的菜单
            }),
            menuDatas:function(){
                if(this.menuData.length>0){
                    //当内存有缓存的时候  直接提取store里面菜单
                    return this.menuData.resources[0].children
                }else{
                    //当刷新的时候  store内存清空了
                 ...
                 //   console.log(temps)
                    if(temps){
                        ...
                        return temps.resources[0].children;
                    }else{
        ...
        methods:{
            ...mapActions(["upDataTotle","setMenuData"]),
